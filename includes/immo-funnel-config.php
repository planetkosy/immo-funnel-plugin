...
$immo_funnel_icons = [
    ...
    'next' => !empty($options_icon['icon_next_inactive']) ? $options_icon['icon_next_inactive'] : plugin_dir_url(__DIR__) . 'assets/icons/next_inactive.png',
    ...
    'send' => !empty($options_icon['icon_send_inactive']) ? $options_icon['icon_send_inactive'] : plugin_dir_url(__DIR__) . 'assets/icons/send_inactive.png',
    ...
    'neu_active' => !empty($options_icon['icon_new_active']) ? $options_icon['icon_new_active'] : plugin_dir_url(__DIR__) . 'assets/icons/new_active.png',
    'neu_hover' => !empty($options_icon['icon_new_hover']) ? $options_icon['icon_new_hover'] : plugin_dir_url(__DIR__) . 'assets/icons/new_hover.png',
    'site_icon' => !empty($options_icon['icon_site_icon']) ? $options_icon['icon_site_icon'] : plugin_dir_url(__DIR__) . 'assets/icons/site_icon.png',
	'site_logo' => !empty($options_icon['icon_site_logo']) ? $options_icon['icon_site_logo'] : plugin_dir_url(__DIR__) . 'assets/icons/site_logo.png',
	'Eigennutzung' => !empty($options_icon['icon_eigen']) ? $options_icon['icon_eigen'] : plugin_dir_url(__DIR__) . 'assets/icons/eigen.png',
    'Vermietung' => !empty($options_icon['icon_rent']) ? $options_icon['icon_rent'] : plugin_dir_url(__DIR__) . 'assets/icons/rent.png',
	...
	'CI_PICTURE' => !empty($options_icon['icon_ci_picture']) ? $options_icon['icon_ci_picture'] : plugin_dir_url(__DIR__) . 'assets/icons/ci_picture.jpg',
];

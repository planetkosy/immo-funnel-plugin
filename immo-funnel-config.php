...
$immo_funnel_icons = [
    'back' => !empty($options_icon['icon_back']) ? $options_icon['icon_back'] : plugin_dir_url(__FILE__) . 'assets/icons/back.png',
    'next_active' => !empty($options_icon['icon_next_active']) ? $options_icon['icon_next_active'] : plugin_dir_url(__FILE__) . 'assets/icons/next_active.png',
    'next' => !empty($options_icon['icon_next_inactive']) ? $options_icon['icon_next_inactive'] : plugin_dir_url(__FILE__) . 'assets/icons/next.png',
    'next_hover' => !empty($options_icon['icon_next_hover']) ? $options_icon['icon_next_hover'] : plugin_dir_url(__FILE__) . 'assets/icons/next_hover.png',
    'send_active' => !empty($options_icon['icon_send_active']) ? $options_icon['icon_send_active'] : plugin_dir_url(__FILE__) . 'assets/icons/send_active.png',
    'send' => !empty($options_icon['icon_send_inactive']) ? $options_icon['icon_send_inactive'] : plugin_dir_url(__FILE__) . 'assets/icons/send.png',
    'send_hover' => !empty($options_icon['icon_send_hover']) ? $options_icon['icon_send_hover'] : plugin_dir_url(__FILE__) . 'assets/icons/send_hover.png',
    'neu_active' => !empty($options_icon['icon_new_active']) ? $options_icon['icon_new_active'] : plugin_dir_url(__FILE__) . 'assets/icons/neu_active.png',
    'neu_hover' => !empty($options_icon['icon_new_hover']) ? $options_icon['icon_new_hover'] : plugin_dir_url(__FILE__) . 'assets/icons/neu_hover.png',
    'site_icon' => !empty($options_icon['icon_site_icon']) ? $options_icon['icon_site_icon'] : plugin_dir_url(__FILE__) . 'assets/icons/planetkosy_site_icon.png',
	'site_logo' => !empty($options_icon['icon_site_logo']) ? $options_icon['icon_site_logo'] : plugin_dir_url(__FILE__) . 'assets/icons/planetkosy_site_logo.png',
	'Eigennutzung' => !empty($options_icon['icon_eigennutzung']) ? $options_icon['icon_eigennutzung'] : plugin_dir_url(__FILE__) . 'assets/icons/eigen.png',
    'Vermietung' => !empty($options_icon['icon_vermietung']) ? $options_icon['icon_vermietung'] : plugin_dir_url(__FILE__) . 'assets/icons/rent.png',
    'Beides' => !empty($options_icon['icon_beides']) ? $options_icon['icon_beides'] : plugin_dir_url(__FILE__) . 'assets/icons/beides.png',
    'EFH' => !empty($options_icon['icon_efh']) ? $options_icon['icon_efh'] : plugin_dir_url(__FILE__) . 'assets/icons/efh.jpg',
    'ETW' => !empty($options_icon['icon_etw']) ? $options_icon['icon_etw'] : plugin_dir_url(__FILE__) . 'assets/icons/etw.jpg',
    'DHH' => !empty($options_icon['icon_dhh']) ? $options_icon['icon_dhh'] : plugin_dir_url(__FILE__) . 'assets/icons/dhh.jpg',
    'RH' => !empty($options_icon['icon_rh']) ? $options_icon['icon_rh'] : plugin_dir_url(__FILE__) . 'assets/icons/rh.jpg',
    'MFH' => !empty($options_icon['icon_mfh']) ? $options_icon['icon_mfh'] : plugin_dir_url(__FILE__) . 'assets/icons/mfh.jpg',
    'GS' => !empty($options_icon['icon_gs']) ? $options_icon['icon_gs'] : plugin_dir_url(__FILE__) . 'assets/icons/gs.jpg',
	...
	'CI_PICTURE' => !empty($options_icon['icon_ci_picture']) ? $options_icon['icon_ci_picture'] : plugin_dir_url(__FILE__) . 'assets/icons/immo_search.jpg',
];
